...
import 'package:vibbra_notifications/modules/auth/tests/mocks/data/remote/http_client.fake.dart';
...
import 'package:vibbra_notifications/modules/sms/tests/fixtures/data/remote/services/sms.service.fixture.dart';
...
void main() async {
  group('Test valid provider register', () {
    ...
    test(
        'Given_ProviderInfo_When_TheUserWillRegister_Then_RegisterIsSuccessfully',
        () async {
      // Given
  ...
  group('Test Invalid Http Login', () {
    ...
    test('Given_ProviderInfo_When_TheUserWillRegister_Then_ReturnError',
        () async {
      // Given
      InsertSmsProviderMapper provider = SmsFixtureValid.generateProvider();
