...
import 'package:vibbra_notifications/modules/auth/tests/mocks/data/local/local_storage.account.fake.dart';
import 'package:vibbra_notifications/modules/auth/tests/mocks/data/local/local_storage.fake.dart';
...
void main() async {
  ...
  group('Test valid on storage user data', () {
    ...
    test('Given_UserDataReceived_When_StoreUserData_Then_StoresSuccessfully',
        () async {
      // Given
  ...
  group('Test exception on storage user data', () {
    ...
    test('Given_UserDataReceived_When_StoreUserData_Then_ReturnAException',
        () async {
      // Given
      Map<String, dynamic> userData = AccountLocalServiceFixture.validJson;
  ...
  group('Test valid on storage keep connected', () {
    ...
    test(
        'Given_KeepConnectedDataReceived_When_StoreData_Then_StoresSuccessfully',
        () async {
      // Given
  ...
  group('Test exception on storage keep connected', () {
    ...
    test('Given_KeepConnectedDataReceived_When_StoreData_Then_ReturnAException',
        () async {
      // Given
      bool keepConnected = AccountLocalServiceFixture.keepConnected;
  ...
  group('Test valid on get user data and decode local data', () {
    ...
    test('Given_UserDataReceived_When_StoreData_Then_StoresSuccessfully',
        () async {
      // Given
